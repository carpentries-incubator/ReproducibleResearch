...
This information will appear on https://amandamiotto.github.io/ReproducibleResearch/instructor/step1Folders.html#data-management-plan
-->
...
There is an excellent list [of 13 rules for naming conventions](https://data-protection.ed.ac.uk/records-management/practical-guidance/naming-conventions) worth the read.
...
If you are working in Python, you can use [`templateproject`](https://github.com/vukovicnikola/templateproject), a Python package developed by researcher Nikola Vukovic to generate a logical, standardised, and flexible directory hierarchy for academic research.
