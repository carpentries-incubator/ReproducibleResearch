...
[eLife guidance on what to include (with examples)](https://elifesciences.org/articles/79627)
...
You can find a [list of electronic laboratory notebook software packages at Wikipedia](https://en.wikipedia.org/wiki/List_of_electronic_laboratory_notebook_software_packages).
...
Thanks to the people in the Cauliflower Pizza story for letting share it!
