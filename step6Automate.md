...
Coding allows you to be very automated, but there are tools you can use that don't need coding, for example:
...
- [n8n](https://n8n.io/)
 ...
 - Workflow systems such as [KNIME](https://www.knime.com/), [Orange Data Mining](https://orangedatamining.com/), and [blockr](https://www.cynkra.com/blockr/)
