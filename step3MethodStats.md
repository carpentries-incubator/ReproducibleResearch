...
The majority of open source software is built on top of other other open source software. For example, [pandas](https://pandas.pydata.org/) is built on top of [NumPy](https://numpy.org/). When describing the computational methods and environment, it is important to include the full dependence tree of the softwares used.
...
Like protocols, there are many benefits to publishing software. Popular places to publish software are
