...
| Unit Number | Street Number | Street Name | Street Type | Suburb | State | Postcode | Country |
| ----------- | ------------- | ----------- | ----------- | ------ | ----- | -------- | ------- |
...
[Open Refine](https://openrefine.org/) is an open source tool that is incredibly useful to clean column data. Your data [doesn't leave your computer](https://openrefine.org/privacy), which makes it safer when working with sensitive data.
...
R has the [`tidyverse`](https://tidyverse.org/) library and Python has the [`pandas`](https://pandas.pydata.org/) library, which follows similar principles.
